    ...
    class Program
    {
        ...
        */
        ...
        public static int SearchInsert(int[] nums, int target)
        {
            try
            {
                //the first if statement returns the maximum number based on the length of the array if the target is greater than the last number in the array.
                //if the target is less than the first number in the array return 0.
                if (nums[nums.Length - 1] < target)
                    return nums.Length;
                if (nums[0] > target)
                    return 0;
                //use binary search to find numbers inside the range of the array.
                int bin_search = Array.BinarySearch(nums, target);
                if (bin_search > -1) 
                // if the bin_search is greater than -1 return the position
                    return bin_search;
                bin_search = Array.BinarySearch(nums, target - 1);
                if (bin_search > -1)
                {
                    //if the bin_search postion in the array is less than the the target, then return the binary search and add one postion
                    if (nums[bin_search] < target)
                        return bin_search + 1;
                }
                bin_search = Array.BinarySearch(nums, target + 1);
                if (bin_search > -1)
                {
                    //if the bin_search postion in the array is greater than the the target then return the binary search
                    if (nums[bin_search] > target)
                        return bin_search;
                }
                // return -1 if none conditions are met
                return -1;
        ...
        */
        ...
        public static string MostCommonWord(string paragraph, string[] banned)
        {
            try
            {
                ...
                string[] array = paragraph.Split(punctuation, StringSplitOptions.RemoveEmptyEntries);
                //use dictionaty to store the value of the words
                Dictionary<string, int> dictionary = new Dictionary<string, int>();
                HashSet<string> hashing = new HashSet<string>();
                ...
                foreach (var item in array)
                {
                    ...
                    // then use the hashing function to convert the string to an integer to value the number of similar words
                    if (hashing.Contains(word))
                        continue;
                    dictionary.TryAdd(word, 0);
                    dictionary[word]++;
                }

                int count = 0;
                string result = "";
                // loop through every key in the dictionary and gets the key with the highest value and stores it in a res variable
        ...
        // the question took me more than an hour as I had to learn to use Dictionary and hashing. I learned how to value the number of strings using the hashing function

        /*
        Question 3:
        Given an array of integers array, a lucky integer is an integer that has a frequency in the array equal to its value.
        ...
        public static int FindLucky(int[] arr)
        {
            try
            {
                // creates a dictionary to store the value of values 
                IDictionary<int, int> valuecount = new Dictionary<int, int>();
                ...
                foreach (var val in valuecount)
                {
                    //FindLucky matching key and value and returns the maximum value  
                    if (val.Key == val.Value)
                    {
                        result = Math.Max(result, val.Value);
                    }
                }
        ...
        Question 4:
        You are playing the bull and cow game with your friend.
        ...
        Output: "1A3B"
        Explanation: bull relate to a '|' and cows are underlined:
        "1807"
          |
        "7810"
        */
        ...
        public static string GetHint(string secret, string guess)
        {
            try
            {
                ...
                for (i = 0; i < secret.Length; i++)
                {
                    ...
                    else { value[secret[i] - '0']++; }
                }

                int cow = 0;

                // loop through all guess characters and checks if the characters do not macth and if they dont it increment the value in cow variable
                for (i = 0; i < guess.Length; i++)
                {
                    if (secret[i] != guess[i] && value[guess[i] - '0'] > 0)
                    {
                        value[guess[i] - '0']--;
                        cow++;
                    }
        ...
        */
        ...
        Return an array res of length 2 where:
             •	res[0] is the total number of lines.
             •	res[1] is the width of the last line in pixels.
        ...
        */
        ...
        public static int UniqueMorseRepresentations(string[] words)
        {
                ...
                Dictionary<char, String> morse = new Dictionary<char, String>()
            {
                ...
                int i = 0;
                // use hashing to store the values to help them match wich allows them to dont have duplicates
                ...
                // return the value of all the items in the hashing
                return hash.Count;
        ...
        // solution took me about an hour. it was a good excercise where I had to use hashing to store the morse item and eliminates duplicates
